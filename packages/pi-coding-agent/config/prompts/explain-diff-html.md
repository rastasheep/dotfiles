---
description: Rich, interactive HTML explanation of a code change, diff, branch, or PR
---
Please make me a rich, interactive explanation of the following code change: $@
